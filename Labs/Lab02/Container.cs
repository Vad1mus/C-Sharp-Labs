...
namespace Lab02
{
    public class Container : IEnumerable
    {
        ...
        public Container(Student[] pArray)
        {
        ...
        public bool RemoveForOption()
        {
            ...
            if (temp.Length != 0)
            {
                int sizePrev = _students.Length;

                for (int i = 0; i < _students.Length; i++)
                {
                    if (comparator.Compare(_students[i], temp) == 0)
                    {
                        Remove(_students[i]);
                        i--;
                    }
        ...
        private class CompareGroups : IComparer
        {
            public int Compare(object x, object y)
            {
                ...
                return student.IndexGroup.CompareTo(y);
            }
        }
        ...
        private class CompareSpecialty : IComparer
        {
            public int Compare(object x, object y)
            {
                ...
                return student.Specialization.CompareTo(data);
            }
        }
